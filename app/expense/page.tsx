    ...
    <DashboardLayout userName={userName}>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Pengeluaran</h1>
            <p className="text-gray-600 text-sm mt-1">Kelola transaksi pengeluaran Anda</p>
          </div>
          <Button 
          ...
          <Card className="border border-gray-200">
            <CardContent className="p-5">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-xs text-gray-500 font-medium mb-1.5">Total Pengeluaran</p>
                  <p className="text-2xl font-semibold text-red-600">{fmt(totalExpense)}</p>
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-orange-600">{fmt(thisMonthExpense)}</p>
              ...
              <div className="text-center py-16">
                ...
                <p className="text-sm text-gray-400">
                  {searchQuery || timeFilter !== 'all' 
                    ...
                    : 'Tambahkan transaksi pengeluaran pertama Anda'}
                </p>
              </div>
            ) : (
              <>
